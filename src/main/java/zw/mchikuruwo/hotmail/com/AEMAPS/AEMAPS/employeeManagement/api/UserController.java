...
import zw.co.stewardbank.hrautomationplatform.dto.AddUserDto;
import zw.co.stewardbank.hrautomationplatform.dto.GenerateCredentialsDto;
import zw.co.stewardbank.hrautomationplatform.dto.LoginDto;
import zw.co.stewardbank.hrautomationplatform.dto.UpdateUserDto;
...
import zw.co.stewardbank.hrautomationplatform.security.JwtTokenProvider;
import zw.co.stewardbank.hrautomationplatform.services.EmailService;
import zw.co.stewardbank.hrautomationplatform.services.LoginService;
import zw.co.stewardbank.hrautomationplatform.services.RoleService;
...
public class UserController {
    ...
    @ApiOperation(value = "Register a user to the Steward Bank HR platform", produces = MediaType.APPLICATION_JSON_VALUE)
    public ApiResponse addUser(@RequestBody AddUserDto addUserDto, @PathVariable("role-id") Integer roleId, HttpServletRequest request){
        ...
        registrationEmail.setSubject("Steward Bank HR Platform");
        registrationEmail.setText(" Dear " + user.getName() + ", \n You have been registered as a  " + roleService.getOne(roleId).getName()
                + " of the Steward Bank HR Platform.\n Email: " + user.getEmailAddress() +"\n Password: " + password +
                ". \n Please keep your password safe and reset it when possible.");
        registrationEmail.setFrom("spencerchiggs@gmail.com");
    ...
    @ApiOperation("Enables a user to login with mobile number and password")
    public ResponseEntity loginWithEmailAndPassword(@RequestBody LoginDto accountCredentials) {
        ...
        if (authentication.isAuthenticated()){
            ...
            response = new ApiResponse(401,"Invalid mobile number or password");
    ...
    public ApiResponse generateCredentialsForUser(@RequestBody GenerateCredentialsDto credentialsDto){
        ...
        generatedCredentialsEmail.setSubject("Steward Bank HR Platform");
        generatedCredentialsEmail.setText(" Dear " + user.getName() + ", \n You have been registered as a  " + user.getRoles().toString()
                + " of the Steward Bank HR Platform.\n Email: " + user.getEmailAddress() +"\n Password: " + password +
                ". \n Please keep your password safe and reset it when possible.");
        generatedCredentialsEmail.setFrom("spencerchiggs@gmail.com");
